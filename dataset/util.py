...
partial_pc_data_dir = os.path.join(root_dir, 'AtlasNetV2.2', 'AtlasNet2', 'partial_pc_data')
...
def get_partial_point_cloud_of_initial_from_goal(file, labelName2InstanceId, view_index, num_samples=5625):
    ...
    partial_pc_cache_file = os.path.join(partial_pc_data_dir, init_filename+'_view-'+str(view_index)+'_partial_pc.pkl')
